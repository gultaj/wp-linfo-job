...
<!--             <div class="job__aside_links"><?= Wp_Linfo_Job_Public::get_archive_link('resume') ?></div> -->
			<div class="job-type__radio">
				<label>
					<input type="radio" name="jobType" id="vacancy" value="vacancy" checked>
			    	<span class="job-type__title is-active">Вакансия</span>
				</label>
				<label>
					<input type="radio" name="jobType" id="resume" value="resume">
			    	<span class="job-type__title">Резюме</span>
				</label>
			</div>
